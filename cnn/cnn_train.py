...
train = pd.read_csv("/home/jdwang/PycharmProjects/kaggleDigitRecognizer/train_test_data/"
                    "train.csv").values
test  = pd.read_csv("/home/jdwang/PycharmProjects/kaggleDigitRecognizer/train_test_data/"
                    "test.csv").values
